...
class LedgerItem < ActiveRecord::Base
  ...
  def copy_from(arg)
    ...
    self.custom_field_values = invoice.custom_field_values.inject({}) {|h,v| h[v.custom_field_id] = v.value; h} if self.respond_to?(:custom_field_values) && invoce.respond_to?(:custom_field_values)
    self
  end
